...
const IconbussinessManFill: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
IconbussinessManFill.defaultProps = {
  size: 18,
};

export default React.memo ? React.memo(IconbussinessManFill) : IconbussinessManFill;
